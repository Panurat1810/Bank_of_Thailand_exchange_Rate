...
def test_validate_type_currency_row_success(mock_good_data_good_currency_row: CurrencyRow) -> None:
...
def test_validate_attribute_currency_row_success(mock_good_data_good_currency_row: CurrencyRow) -> None:
...
def test_validate_attribute_currency_row_failed(mock_bad_data_good_currency_row: CurrencyRow) -> None:
