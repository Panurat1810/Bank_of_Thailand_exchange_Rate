...
def test_create_csv_file_success(mock_good_data: List[CurrencyRow]) -> NoReturn:
    obj = Currency()
...
def test_create_csv_file_failed(mock_to_csv, mock_good_data: List[CurrencyRow]) -> NoReturn:
...
def test_create_parquet_file_success(mock_good_data: List[CurrencyRow]) -> NoReturn:
    obj = Currency()
    mock_table = list(mock_good_data)
...
def test_create_parquet_file_failed(mock_to_parquet, mock_good_data: List[CurrencyRow]) -> NoReturn:
